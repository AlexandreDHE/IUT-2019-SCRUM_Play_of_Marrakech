...
public class PlayScreen extends JFrame{
	...
	public JButton lancerde = new JButton("Lancer le dÃ©");

	public PlayScreen(Game game){

		JButton up = new JButton("â–²");
		JButton down = new JButton("â–¼");
		JButton left = new JButton("â—€");
		JButton right = new JButton("â–¶");
		...
		switch (game.getJoueurs().length) {
			...
			leftpanel.add(new ScorePanel(players[0],1,1,0,1));
			leftpanel.add(new ScorePanel(players[1],1,1,1,1));
			...
			rightpanel.add(new ScorePanel(players[3],1,1,1,1));
